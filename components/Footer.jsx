    ...
    const linkSections = [
        {
            title: "Productos",
            links: [
                { text: "Auriculares", path: '/', icon: null },
        ...
        },
        {
            ...
            links: [
                ...
                { text: "Politica de privacidad", path: '/', icon: null },
                { text: "Hazte miembro Plus", path: '/pricing', icon: null },
                { text: "Crea tu tienda", path: '/create-store', icon: null },
            ]
        },
        {
            title: "CONTACTO",
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Bienvenido a gocart, tu destino definitivo para los gadgets más recientes e inteligentes. Desde teléfonos inteligentes y relojes inteligentes hasta accesorios esenciales, te ofrecemos lo mejor en innovación, todo en un solo lugar.</p>
