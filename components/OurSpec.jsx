...
const OurSpecs = () => {
    ...
    return (
        <div className='px-6 my-20 max-w-6xl mx-auto'>
            <Title visibleButton={false} title='Nuestras Especificaciones' description="Ofrecemos un servicio de primera y comodidad para garantizar que su experiencia de compra sea fluida, segura y completamente sin complicaciones." />
