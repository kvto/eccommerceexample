...
export const ourSpecsData = [
    { title: "Envío Gratis", description: "Disfruta de entrega rápida y gratuita en todos los pedidos sin condiciones, solo entrega confiable a domicilio.", icon: SendIcon, accent: '#05DF72' },
    { title: "Devolución fácil en 7 días", description: "¿Cambiaste de opinión? No te preocupes. Devuelve cualquier artículo dentro de los 7 días.", icon: ClockFadingIcon, accent: '#FF8904' },
    { title: "Soporte al cliente 24/7", description: "Estamos aquí para ti. Obtén ayuda experta con nuestro servicio de atención al cliente.", icon: HeadsetIcon, accent: '#A684FF' }
]
